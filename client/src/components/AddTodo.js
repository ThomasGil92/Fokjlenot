...
const AddTodo = () => {
    ...
    return (
        <div className="container-fluid vh-100 d-flex align-items-center text-fokjleno">
            <HomeMenu />
            <Cookie/>
            <div className="col-md-5 card mx-auto border-0 mt-5" >
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="d-flex justify-content-between">
                            <Link className="d-flex btn btn-outline-info align-items-center" to={"/"}><i className="fas fa-angle-double-left mr-1"></i>Revenir à l'accueil</Link>
                            <input type="submit" value="Ajouter cette tâche" className="btn btn-primary " />
                        </div>
                    </form>
                </div>
            </div>
