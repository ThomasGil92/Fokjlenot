...
const LandingPresentationFirstBlock = () => {
    return (
        <div className="col-md-10 mx-auto text-fokjlenot mt-4">
            <div className="row p-0 h-100 d-flex justify-content-between " style={{ minHeight: "400px" }}>
                <div
                    className="col-6 d-flex justify-content-center rounded align-items-center"
                ...
                <div className="col-6 d-flex justify-content-center align-items-center">
                    <div className="py-2 col-md-10 text-center">
