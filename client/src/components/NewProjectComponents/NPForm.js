                    ...
                    <div className="card-body">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="form-group mb-4">
                                <input type="text" id="title" name="title" required value={project.title} onBlur={(e) => focusOff(e)} onFocus={(e) => this.focus(e)} onChange={handleChange} className="form-control" placeholder="Nom du Projet" />
                            </div>
                            <div className="form-group mb-4">
